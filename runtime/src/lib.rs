...
/// Import the quadratic-funding pallet.
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// Include the custom logic from the pallet-quadratic-funding in the runtime.
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			list_benchmark!(list, extra, pallet_quadratic_funding, QuadraticFunding);
